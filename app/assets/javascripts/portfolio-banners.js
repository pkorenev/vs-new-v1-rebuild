/*
    Animation for Voronin Studio Web Banner
*/

function AnimateVoroninWebP(){
    $('.webpr-vs').animate({left: 0}, {duration: 4000, easing: 'easeOutElastic'});
}
...
/* Start Parallax For Invest Intelegments Banner */


// Animation function for layers

    // Selectors setting
    var $layer1 = $('.ii-main-logo-image');
    var $layer2 = $('.ii-additional-image');
    var $layer3 = $('.ii-blured_big_1-image');
    var $layer4 = $('.ii-blured_medium_3-image');
    var $layer5 = $('.ii-blured_small_2-image');

    // Animate layers
    // Logo Up Down push
    function layer_1_play(){
        $layer1.animate(
            { top: 100 },
            { duration: 2000, easing: 'easeOutBack' }
        );
    }

function AnimateIIBanner(){
    window.setTimeout(layer_1_play, 2000);
}


// Initialize function for II parallax Effect
function InitializeIIParallax(){
    $('.parallax-layer').parallax();
}

window.setTimeout(AnimateIIBanner, 3000);
