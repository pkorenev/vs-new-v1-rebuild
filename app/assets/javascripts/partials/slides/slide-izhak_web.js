$(document).on('ready page:load',function(){
    $('#slide-izhak_web').each(function(){
        (function($){
            var $slide = $('#slide-izhak_web');
            var $crystal_layers = $slide.find('.layer.crystal');

            var $izhak_web_left_arrow = $slide.find('#izhak_web-left-arrow');
            var $izhak_web_letter = $slide.find('#izhak_web-letter');
            var $izhak_web_top_center_arrow = $slide.find('#izhak_web-top-center-arrow');
            var $izhak_web_letter_arrow = $slide.find('#izhak_web-letter-arrow');
            var $izhak_web_bottom_right_arrow = $slide.find('#izhak_web-bottom-right-arrow');
            var $description = $slide.find('.description');


            //
            var $izhak_web_3a = $slide.find('#izhak_web-3a')
            var $izhak_web_4 = $slide.find('#izhak_web-4')
            var $izhak_web_3 = $slide.find('#izhak_web-3')
            var $izhak_web_2 = $slide.find('#izhak_web-2')



// init
            //$izhak_web_left_arrow.data('step_ratio',0.15);
            $izhak_web_left_arrow.data('step_ratio',0.05);
            $izhak_web_letter.data('step_ratio',0.04);
            $izhak_web_top_center_arrow.data('step_ratio',0.35);
            $izhak_web_letter_arrow.data('step_ratio',0.04);
            $izhak_web_bottom_right_arrow.data('step_ratio',0.4);

            $izhak_web_3a.data('step_ratio', 0.1)
            $izhak_web_4.data('step_ratio', 0.3)// вилка
            $izhak_web_3.data('step_ratio', 0.15) // лапша
            $izhak_web_2.data('step_ratio', 0.25)
            ...
            $slide.on( "playSlideAnimation", function() {
                ...
                $izhak_web_left_arrow.removeClass('final-position').addClass('display-slide');
                $izhak_web_left_arrow.switchClass('display-slide','final-position',1000,'easeInOutQuad');
                //$izhak_web_left_arrow.removeClass('display-slide').addClass('final-position');

                $izhak_web_letter.removeClass('final-position').addClass('display-slide');
                $izhak_web_letter.switchClass('display-slide','final-position',1500,'easeOutBack');
                //$izhak_web_letter.removeClass('display-slide').addClass('final-position').css('animation-name','kf').css('animation-name','slidein');

                $izhak_web_letter_arrow.removeClass('final-position').addClass('display-slide');
                $izhak_web_letter_arrow.switchClass('display-slide','final-position',1500,'easeOutBack');
                //$izhak_web_letter_arrow.removeClass('display-slide').addClass('final-position');

                $izhak_web_top_center_arrow.removeClass('final-position').addClass('display-slide');
                $izhak_web_top_center_arrow.switchClass('display-slide','final-position',1000,'easeInOutQuad');
                //$izhak_web_top_center_arrow.removeClass('display-slide').addClass('final-position');

                $izhak_web_bottom_right_arrow.removeClass('final-position').addClass('display-slide');
                $izhak_web_bottom_right_arrow.switchClass('display-slide','final-position',1000,'easeInOutQuad');
                //$izhak_web_bottom_right_arrow.removeClass('display-slide').addClass('final-position');
