...
module StudioVoronin
  class Application < Rails::Application
    ...
    config.assets.precompile += %w(ckeditor/plugins/codemirror/* ckeditor/plugins/codemirror/lang/* ckeditor/plugins/codemirror/css/* ckeditor/plugins/codemirror/js/* ckeditor/plugins/codemirror/icons/* ckeditor/plugins/codemirror/theme/*)
